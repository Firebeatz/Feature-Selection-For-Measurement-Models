...
# g) Wrapper Implementation with ANN and antColony search algorithm using FSinR from 
...
FSCalculationNeuralNet <- function (f, i) {
  ...
  grid <- expand.grid(layer1 = 4, layer2 = 2, layer3 = 0)
  ...
  evaluator <- wrapperEvaluator("neuralnet",
                                resamplingParams,
                                fittingParams)
